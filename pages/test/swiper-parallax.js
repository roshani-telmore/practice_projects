...
export default function App() {
  // const arr=[1,2,3]
  // for(let i in arr){
  //   console.log("This is the for loop",arr[i])
  // };

  // arr.map((i)=>{
  //   console.log("THis is the map",i)
  // })
  return (
    <>
      <Swiper
